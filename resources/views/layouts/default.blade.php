    ...
    <div class="wrapper">
      ...
      <footer class="main-footer hidden-print">
        ...
        @endif
          ...
          <a target="_blank" href="https://kraktau-it.co.id" rel="noopener">KRAKATAU-IT</a> powered with <i class="fa fa-heart" style="color: #a94442; font-size: 10px" aria-hidden="true"></i><span class="sr-only">love</span> by <a href="https://twitter.com/cuangkyfamily" rel="noopener">@cuangky</a>.
      </footer>
